...
export default function Home() {
  ...
  // Update water level calculation to match Arduino's 0-3m scale
  ...
  const lastUpdate = waterData.lastUpdate;
  ...
  const chartData = {
    labels: Array(6).fill('').map((_, i) => {
      const date = new Date();
      date.setMinutes(date.getMinutes() - (5-i) * 10);
      return date.toLocaleTimeString('id-ID', { hour: '2-digit', minute: '2-digit' });
    }),
    values: [waterData.height] // You'll need to implement data history storage
  };
        ...
        <div className={fadeIn}>	
                  ...
                  <div className="bg-slate-800/50 backdrop-blur-md rounded-2xl p-8 border border-slate-700">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="col-span-1 bg-gray-800/30 backdrop-blur-sm border border-white/5 rounded-lg p-3">
                        ...
                        <div className="flex items-center">
                          <BeakerIcon className="w-5 h-5 mr-2 text-purple-300" />
                          <p className="font-medium">{waterData.rate.toFixed(2)} m/s</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-8">
                <div className={`bg-white p-6 rounded-xl shadow-sm border border-gray-100 
                  ...
                  <div className="flex items-center space-x-2">
                    <BeakerIcon className="text-blue-500 text-xl" />
          ...
          {activeTab === 'analisis' && (
            <div className="bg-slate-800/50 backdrop-blur-md rounded-xl p-6">
              <h2 className="text-xl font-semibold mb-4 text-white">Analisis Data</h2>
          ...
          {activeTab === 'pengaturan' && (
            <div className="bg-slate-800/50 backdrop-blur-md rounded-xl p-6">
              <h2 className="text-xl font-semibold mb-4 text-white">Pengaturan</h2>
